...
export function InterfaceSelector() {
  ...
  const interfaceOptions: InterfaceOption[] = [
    {
      ...
      description: "Interface de chat clássica com suporte a todas as funcionalidades.",
    ...
    },
    {
      ...
      description: "Nova interface com respostas em tempo real e suporte avançado a eventos Genkit.",
  ...
  const isActive = (path: string) => {
    ...
    if (path !== "/chat" && pathname?.includes(path.split("/").pop() || "")) return true;
    return false;
  };
