  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-4 text-center">
      ...
      <p className="text-muted-foreground mb-10 max-w-md">
        Você pode começar com uma das sugestões abaixo ou digitar sua própria pergunta.
      </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl">
          {suggestions.map((suggestion) => (
            <Card 
              ...
              onClick={() => onSuggestionClick(suggestion.actionText || suggestion.title)}
            >
              <CardHeader className="pb-2">
                <div className="flex items-center gap-3">
                  {suggestion.icon && <suggestion.icon className="w-6 h-6 text-primary flex-shrink-0" />}
