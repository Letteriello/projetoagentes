              ...
              {selectedToolIds.length > 0 ? (
                <div className="space-y-2">
                  {selectedToolIds.map(toolId => {
                    ...
                    return (
                      <div key={toolId} className="flex items-center justify-between p-2 border rounded-md">
                        ...
                        <Button 
                          variant="ghost" 
                          size="sm"
                          onClick={() => handleToolSelectionChange(toolId, false)}
                        >
                          Remover
                        </Button>
                      </div>
                ...
                <p className="text-muted-foreground">Nenhuma ferramenta selecionada</p>
              )}
            </CardContent>
          </Card>
        </div>
