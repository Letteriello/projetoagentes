...
const TrashIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
    <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12.56 0c1.153 0 2.243.032 3.287.096m7.971.016A48.108 48.108 0 0 1 12 5.69m0 0a48.108 48.108 0 0 1-3.478-.397m0-.096c1.153 0 2.243.032 3.287.096" />
  </svg>
);
      ...
      >
        {isOpen && ( // Only render content if open to prevent layout issues when collapsed
          <>
            ...
            {/* Conversation List */}
            <div className="flex-1 overflow-y-auto custom-scrollbar-dark -mr-2 pr-2"> {/* Negative margin for scrollbar */}
                    ...
                    <li key={conv.id} className="group relative">
                      ...
                      >
                        ...
                        {renamingId !== conv.id && (
                           ...
                           <button
                             onClick={(e) => { e.stopPropagation(); onDeleteConversation(conv); }} // Pass the full conversation object
